$(function () {
  ...
  var demos = {
    ...
    transforms: function (demo) {
      return demo
        .set('top', ['40%','45%','45%', '50%'])
        .transform('rotateX', ['-90deg','-180deg','-90deg','0deg'])
        .transform('rotateZ', ['90deg','180deg','270deg','360deg']);
    },
    treflip: function (demo, ease) {
      return demo
        .setEase("ease-out-cubic")
        .set('top', ['45%','50%'])
        .transform('rotateZ', ['-360deg'])
        .transform('rotateX', ['360deg']);
    },
    kickflip: function (demo) {
      return demo
        .set('top', ['45%','50%'])
        .transform('rotateX', ['-360deg','-360deg'])
    },
    shuvit: function (demo) {
      return demo
        .set('top', ['45%','50%'])
